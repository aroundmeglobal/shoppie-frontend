    ...
    <main className="bg-[url(/login-background.png)] bg-fixed bg-cover min-h-screen flex flex-col">
      ...
      <div className="flex flex-1 items-center justify-center overflow-hidden mx-2 ">
        <div className="w-[900px] flex rounded-2xl overflow-hidden shadow-lg h-[25rem]">
          <div className="md:w-1/2 w-full   bg-authCard p-6 shadow-lg flex flex-col h-full justify-center">
            <h2 className="text-xl font-bold text-white">Verify your Email</h2>

            <p className="mt-1 text-[#cacaca] text-[13px] font-extralight font-[BR Firma]  ">
              Enter the code we sent to
              <br />
              <span className="text-[#cacaca]">{email || "Adsfasdfasf"}</span>
              <button
                onClick={onChangeEmail}
                className="text-white font-extralight mt-1 text-sm ml-2 underline"
              >
                Change
              </button>
            </p>
            ...
            <button
              className={`mt-4 w-full rounded-xl ${
                otp.every((digit) => digit !== "")
                  ...
                  : "bg-[#5a5a5a] "
              } px-4 py-3 text-white font-semibold hover:bg-gray-500 transition`}
